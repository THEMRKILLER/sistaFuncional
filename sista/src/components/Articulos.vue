        ...
        <div class="container">
          <div class="col-md-12">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="../assets/img/logo2.png" class="img-responsive" style="width: 140px; margin-top: 0px; margin-left: 130px;"></a>
            </div>
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                <li class="active"><a href="#">Inicio</a></li>
                <li class=""><a href="#">Crear</a></li>
                <li class=""><a href="#">Feugiat</a></li>
                <li class=""><a href="#">Tempus</a></li>
                ...
                <div class="row">
                  <div class="col-sm-8 col-md-8">
                    <div class="thumbnail">
                      ...
                      <img :src="articulo.caratula" class="caratula img-responsive" alt=""/>
                      </a>
                    </div>
                  </div>
                </div>
                
                <small><p>{{articulo.resumen}}</p></small>
                <footer>
                  <ul class="actions">
